...
import { MapPin, Star, MessageCircle, CheckCircle, Award } from "lucide-react";
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1">
                ...
                {w.badge && <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-primary/10 text-primary shrink-0">{w.badge}</span>}
              </div>

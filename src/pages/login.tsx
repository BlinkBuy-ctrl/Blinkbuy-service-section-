    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to BlinkBuy Services</p>
        </div>
        ...
        <button onClick={handleGoogle}
          className="w-full mt-3 bg-card border border-card-border py-3 rounded-xl text-sm font-semibold hover:bg-muted transition-all flex items-center justify-center gap-2">
